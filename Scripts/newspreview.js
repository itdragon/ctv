function formatNumberValue(n) {
    for (var i = n.toString().length, r = 0, u = "", f = "", t; i % 3 != 0;)
        i++, r++;
    if (r != 0)
        for (t = 0; t < r; t++)
            u += "0";
    for (u += n.toString(), t = 0; t < i; t++)
        f += u.charAt(t), t > 0 && (t + 1) % 3 == 0 && t != i - 1 && (f += ".");
    return f.substring(r)
}
function reloadlazy() {
    $("img.lazyThread").lazyload({ threshold: 100 });
    $("img.lazy").lazyload({ threshold: 100 });
    $(".leftdetail img").lazyload({ threshold: 100 })
}
function fancyBoxGallaryImg(n) {
    try {
        $(n).click(function (t) {
            var i = $(this);
            if (t.preventDefault(), typeof $.fancybox == "undefined") {
                $.getScript(rootnews + "/Scripts/desktop/fancybox.js").done(function () {
                    $(n).fancybox({
                        transitionIn: "none", transitionOut: "none", titlePosition: "over", titleFormat: function (n, t, i) {
                            return '<span id="fancybox-title-over">Image ' + (i + 1) + " / " + t.length + " " + n + "<\/span>"
                        }
                    });
                    $(i).click()
                });
...
function showdiscuss() {
    var n = $("#viewdiscuss").attr("data-surveyid"), t = $("#viewdiscuss").attr("data-newsid");
    discussbuildcapchar(t, n)
}
function discusscheck(n) {
    $("#discussrd-" + n).is(":checked") || $("#discussrd-" + n).attr("checked", !0)
}
function discussbuildcapchar(n, t) {
    $("input:radio[name='discussgroup']").is(":checked") ? $.ajax({
        url: rootnews + "/aj/NewsDetail/CheckCapcharSessionInsertOrUpdateSurveyUserAnswer", type: "Post", cache: !1, error: function () {
        }, success: function (i) {
            i == "0" ? discusssavefirst(n, t) : alert("Bạn đã bình chọn rồi")
        }
    }) : $("#lalertdiscuss").fadeIn(function () {
        setTimeout(function () {
            $("#lalertdiscuss").hide()
        }, 3e3)
    })
}
function discusssavefirst(n, t) {
    var i = $("input[name='discussgroup']:checked").val(), r = { NewsId: n, AnswerId: i, intQuestionId: t };
    $.ajax({
        url: rootnews + "/aj/NewsDetail/InsertOrUpdateSurveyUserAnswer", type: "Post", data: r, cache: !1, error: function () {
            $("#status-capchardiscuss").html("Có lỗi xảy ra, Vui lòng thử lại sau");
            $("#status-capchardiscuss").show()
        }, success: function () {
            discusshide();
            discussshowresult(n, t)
        }
    })
}
function discusshide() {
    $(".modal-backdrop").remove();
    $("#discuss-newsdetail").hide()
}
function discussshowresult(n, t) {
    var i = { NewsId: n, QuestionId: t };
    $.ajax({
        url: rootnews + "/aj/NewsDetail/GetSurveyUserAnswerByNewsAndQuestion", type: "Post", data: i, cache: !1, error: function () {
            alert(1)
        }, success: function (n) {
            n != "" && ($("body").append('<div class="modal-backdrop fade in"><\/div>'), $("#discuss-newsdetail").html(n), $("#discuss-newsdetail").show())
        }
    })
}
var loadmore, flsc;
(function (n, t) {
    ...
    function ai(n, t) {
        for (var r, o, e = [], f = 0, s = n.length; f < s; f++)
            (r = n[f], r.style) && (e[f] = i._data(r, "olddisplay"), t ? (!e[f] && r.style.display === "none" && (r.style.display = ""), r.style.display === "" && tt(r) && (e[f] = i._data(r, "olddisplay", wi(r.nodeName)))) : (o = u(r, "display"), !e[f] && o !== "none" && i._data(r, "olddisplay", o)));
        for (f = 0; f < s; f++)
    ...
    function pi(n, t, r) {
        ...
        if (f <= 0 || f == null) {
            if (f = u(n, t), (f < 0 || f == null) && (f = n.style[t]), ot.test(f))
                return f;
    ...
    function wi(n) {
        ...
        return f.remove(), (t === "none" || t === "") && (y = r.body.appendChild(y || i.extend(r.createElement("iframe"), { frameBorder: 0, width: 0, height: 0 })), p && y.createElement || (p = (y.contentWindow || y.contentDocument).document, p.write("<!doctype html><html><body>"), p.close()), f = p.body.appendChild(p.createElement(n)), t = u(f, "display"), r.body.removeChild(y)), ti[n] = t, t
    }
    function vt(n, t, r, u) {
        var f;
        if (i.isArray(t))
    ...
    function it(n, i, r, u, f, e) {
        ...
        for (var o, s = n[f], h = 0, l = s ? s.length : 0, c = n === ii; h < l && (c || !o) ; h++)
            o = s[h](i, r, u), typeof o == "string" && (!c || e[o] ? o = t : (i.dataTypes.unshift(o), o = it(n, i, r, u, o, e)));
    ...
    function nr(n, t, r) {
        var e, o = 0, c = lt.length, f = i.Deferred().always(function () {
            ...
            elem: n, props: i.extend({}, t), opts: i.extend(!0, { specialEasing: {} }, r), originalProperties: t, originalOptions: r, startTime: b || gi(), duration: r.duration, tweens: [], createTween: function (t, r) {
        ...
        for (gu(s, u.opts.specialEasing) ; o < c; o++)
            if (e = lt[o].call(u, n, s, u.opts), e)
                return e;
        return du(u, s), i.isFunction(u.opts.start) && u.opts.start.call(n, u), i.fx.timer(i.extend(h, { anim: u, queue: u.opts.queue, elem: n })), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always)
    }
    function gu(n, t) {
        var r, f, e, u, o;
        for (r in n)
    ...
    function nf(n, t, r) {
        ...
        for (o in t)
            if (a = t[o], ao.exec(a)) {
                if (delete t[o], y = y || a === "toggle", a === (c ? "hide" : "show"))
                    continue;
                w.push(o)
            }
        if (v = w.length, v)
            for (s = i._data(n, "fxshow") || i._data(n, "fxshow", {}), ("hidden" in s) && (c = s.hidden), y && (s.hidden = !c), c ? i(n).show() : h.done(function () {
                ...
                u = w[o], l = h.createTween(u, c ? s[u] : 0), p[u] = s[u] || i.style(n, u), u in s || (s[u] = l.start, c && (l.end = l.start, l.start = u === "width" || u === "height" ? 1 : 0))
    }
        ...
        constructor: i, init: function (n, u, f) {
            ...
            if (typeof n == "string") {
                if (e = n.charAt(0) === "<" && n.charAt(n.length - 1) === ">" && n.length >= 3 ? [null, n, null] : hf.exec(n), e && (e[1] || !u)) {
                    if (e[1])
                        return u = u instanceof i ? u[0] : u, s = u && u.nodeType ? u.ownerDocument || u : r, n = i.parseHTML(e[1], s, !0), fr.test(e[1]) && i.isPlainObject(u) && this.attr.call(n, u, !0), i.merge(this, n);
    ...
    i.ready.promise = function (t) {
        if (!ut)
            if (ut = i.Deferred(), r.readyState === "complete")
    ...
    i.support = function () {
        ...
        if (t.setAttribute("className", "t"), t.innerHTML = "  <link/><table><\/table><a href='/a'>a<\/a><input type='checkbox'/>", h = t.getElementsByTagName("*"), e = t.getElementsByTagName("a")[0], !h || !e || !h.length)
            return {};
        ...
        u = { leadingWhitespace: t.firstChild.nodeType === 3, tbody: !t.getElementsByTagName("tbody").length, htmlSerialize: !!t.getElementsByTagName("link").length, style: /top/.test(e.getAttribute("style")), hrefNormalized: e.getAttribute("href") === "/a", opacity: /^0.5/.test(e.style.opacity), cssFloat: !!e.style.cssFloat, checkOn: f.value === "on", optSelected: l.selected, getSetAttribute: t.className !== "t", enctype: !!r.createElement("form").enctype, html5Clone: r.createElement("nav").cloneNode(!0).outerHTML !== "<:nav><\/:nav>", boxModel: r.compatMode === "CSS1Compat", submitBubbles: !0, changeBubbles: !0, focusinBubbles: !1, deleteExpando: !0, noCloneEvent: !0, inlineBlockNeedsLayout: !1, shrinkWrapBlocks: !1, reliableMarginRight: !0, boxSizingReliable: !0, pixelPosition: !1 };
        f.checked = !0;
    ...
    sr = /([A-Z])/g;
    i.extend({
        cache: {}, deletedIds: [], uuid: 0, expando: "jQuery" + (i.fn.jquery + Math.random()).replace(/\D/g, ""), noData: { embed: !0, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: !0 }, hasData: function (n) {
    ...
    i.fn.extend({
        data: function (n, r) {
            ...
            return typeof n == "object" ? this.each(function () {
                ...
                if (r === t)
                    return f = this.triggerHandler("getData" + s, [u[0]]), f === t && e && (f = i.data(e, n), f = ui(e, n, f)), f === t && u[1] ? this.data(u[0]) : f;
                u[1] = r;
                this.each(function () {
                    var t = i(this);
        ...
        valHooks: {
            ...
            if (t && n.nodeType === 1)
                for (f = t.split(h) ; o < f.length; o++)
                    r = f[o], r && (u = i.propFix[r] || r, e = ar.test(r), e || i.attr(n, r, ""), n.removeAttribute(vr ? r : u), e && u in n && (n[u] = !1))
        }, attrHooks: {
            type: {
                set: function (n, t) {
    ...
    var bt = /^(?:textarea|input|select)$/i, yr = /^([^\.]*|)(?:\.(.+)|)$/, ne = /(?:^|\s)hover(\.\S+|)\b/, te = /^key/, ie = /^(?:mouse|contextmenu)|click/, pr = /^(?:focusinfocus|focusoutblur)$/, wr = function (n) {
    ...
    i.event = {
        add: function (n, r, u, f, e) {
            ...
            if (n.nodeType !== 3 && n.nodeType !== 8 && r && u && (a = i._data(n))) {
                ...
                }, s.elem = n), r = i.trim(wr(r)).split(" "), y = 0; y < r.length; y++)
                    p = yr.exec(r[y]) || [], o = p[1], b = (p[2] || "").split(".").sort(), h = i.event.special[o] || {}, o = (e ? h.delegateType : h.bindType) || o, h = i.event.special[o] || {}, l = i.extend({ type: o, origType: p[1], data: f, handler: u, guid: u.guid, selector: e, needsContext: e && i.expr.match.needsContext.test(e), namespace: b.join(".") }, w), c = v[o], c || (c = v[o] = [], c.delegateCount = 0, h.setup && h.setup.call(n, f, b, s) !== !1 || (n.addEventListener ? n.addEventListener(o, s, !1) : n.attachEvent && n.attachEvent("on" + o, s))), h.add && (h.add.call(n, l), l.handler.guid || (l.handler.guid = u.guid)), e ? c.splice(c.delegateCount++, 0, l) : c.push(l), i.event.global[o] = !0;
                n = null
            }
            ...
            props: "button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "), filter: function (n, i) {
    ...
    i.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function (n, t) {
        ...
        function g(n, t) {
            ...
            for (i = n, c = [], l = u.preFilter; i;) {
                ...
                for (s in u.filter)
                    (f = et[s].exec(i)) && (!l[s] || (f = l[s](f))) && (h.push(o = new ri(f.shift())), i = i.slice(o.length), o.type = s, o.matches = f);
                if (!o)
                    break
            }
        ...
        function ht(n, t, i, r, u, f) {
            return r && !r[e] && (r = ht(r)), u && !u[e] && (u = ht(u, f)), s(function (f, e, o, s) {
                ...
                if (f) {
                    ...
                    h = nt(h === e ? h.splice(b, h.length) : h), u ? u(null, e, h, s) : p.apply(e, h)
            })
        }
        function ct(n) {
        ...
        function lt(n, t, i, r, f) {
            ...
            if (!r && h.length === 1) {
                if (e = h[0] = h[0].slice(0), e.length > 2 && (s = e[0]).type === "ID" && t.nodeType === 9 && !f && u.relative[e[1].type]) {
                    if (t = u.find.ID(s.matches[0].replace(y, ""), t, f)[0], !t)
                        return i;
        ...
        u = r.selectors = {
            cacheLength: 50, createPseudo: s, match: et, attrHandle: tr ? {} : {
                href: function (n) {
                ...
                }, radio: b("radio"), checkbox: b("checkbox"), file: b("file"), password: b("password"), image: b("image"), submit: gt("submit"), reset: gt("reset"), button: function (n) {
                    var t = n.nodeName.toLowerCase();
        ...
        yt = r.compile = function (n, t) {
            var r, u = [], f = [], i = ei[e][n + " "];
            if (!i) {
                for (t || (t = g(n)), r = t.length; r--;)
                    i = ct(t[r]), i[e] ? u.push(i) : f.push(i);
                i = ei(n, ci(f, u))
            }
            return i
        };
            ...
            lt = function (t, i, r, u, f) {
                if (!u && !f && !n.test(t)) {
                    ...
                    if (i.nodeType === 1 && i.nodeName.toLowerCase() !== "object") {
                        for (o = g(t), (a = i.getAttribute("id")) ? c = a.replace(h, "\\$&") : i.setAttribute("id", c), c = "[id='" + c + "'] ", l = o.length; l--;)
                            o[l] = c + o[l].join("");
    ...
    var re = /Until$/, ue = /^(?:parents|prev(?:Until|All))/, fe = /^.[^:#\[\.,]*$/, br = i.expr.match.needsContext, ee = { children: !0, contents: !0, next: !0, prev: !0 };
    i.fn.extend({
        find: function (n) {
    ...
    var kr = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", oe = / jQuery\d+="(?:null|\d+)"/g, kt = /^\s+/, dr = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, gr = /<([\w:]+)/, se = /<tbody/i, he = /<|&#?\w+;/, ce = /<(?:script|style|link)/i, le = /<(?:script|object|embed|option|style)/i, dt = new RegExp("<(?:" + kr + ")[\\s/>]", "i"), nu = /^(?:checkbox|radio)$/, tu = /checked\s*(?:[^=]|=\s*.checked.)/i, ae = /\/(java|ecma)script/i, ve = /^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g, e = { option: [1, "<select multiple='multiple'>", "<\/select>"], legend: [1, "<fieldset>", "<\/fieldset>"], thead: [1, "<table>", "<\/table>"], tr: [2, "<table><tbody>", "<\/tbody><\/table>"], td: [3, "<table><tbody><tr>", "<\/tr><\/tbody><\/table>"], col: [2, "<table><tbody><\/tbody><colgroup>", "<\/colgroup><\/table>"], area: [1, "<map>", "<\/map>"], _default: [0, "", ""] }, iu = oi(r), gt = iu.appendChild(r.createElement("div"));
    e.optgroup = e.option;
        ...
        text: function (n) {
            ...
            if (this[0]) {
                ...
                c.length && i.each(c, function (n, t) {
                    t.src ? i.ajax ? i.ajax({ url: t.src, type: "GET", dataType: "script", async: !1, global: !1, throws: !0 }) : i.error("no ajax") : i.globalEval((t.text || t.textContent || t.innerHTML || "").replace(ve, ""));
    ...
    i.buildFragment = function (n, u, f) {
        var o, s, h, e = n[0];
        return u = u || r, u = !u.nodeType && u[0] || u, u = u.ownerDocument || u, n.length === 1 && typeof e == "string" && e.length < 512 && u === r && e.charAt(0) === "<" && !le.test(e) && (i.support.checkClone || !tu.test(e)) && (i.support.html5Clone || !dt.test(e)) && (s = !0, o = i.fragments[e], h = o !== t), o || (o = u.createDocumentFragment(), i.clean(n, u, o, f), s && (i.fragments[e] = h && o)), { fragment: o, cacheable: s }
    };
    i.fragments = {};
    ...
    i.extend({
        clone: function (n, t, r) {
            ...
            if (i.support.html5Clone || i.isXMLDoc(n) || !dt.test("<" + n.nodeName + ">") ? e = n.cloneNode(!0) : (gt.innerHTML = n.outerHTML, gt.removeChild(e = gt.firstChild)), (!i.support.noCloneEvent || !i.support.noCloneChecked) && (n.nodeType === 1 || n.nodeType === 11) && !i.isXMLDoc(n))
                for (hi(n, e), f = nt(n), o = nt(e), u = 0; f[u]; ++u)
                    o[u] && hi(f[u], o[u]);
            if (t && (si(n, e), r))
                for (f = nt(n), o = nt(e), u = 0; f[u]; ++u)
                    si(f[u], o[u]);
            return f = o = null, e
            ...
            for (t && typeof t.createDocumentFragment != "undefined" || (t = r), h = 0; (o = n[h]) != null; h++)
                if (typeof o == "number" && (o += ""), o) {
                    if (typeof o == "string")
                        if (he.test(o)) {
                            for (y = y || oi(t), s = t.createElement("div"), y.appendChild(s), o = o.replace(dr, "<$1><\/$2>"), p = (gr.exec(o) || ["", ""])[1].toLowerCase(), v = e[p] || e._default, d = v[0], s.innerHTML = v[1] + o + v[2]; d--;)
                                s = s.lastChild;
                            if (!i.support.tbody)
                                for (w = se.test(o), a = p === "table" && !w ? s.firstChild && s.firstChild.childNodes : v[1] === "<table>" && !w ? s.childNodes : [], c = a.length - 1; c >= 0; --c)
    ...
    var u, y, p, ni = /alpha\([^)]*\)/i, ye = /opacity=([^)]*)/, pe = /^(top|right|bottom|left)$/, we = /^(none|table(?!-c[ea]).+)/, ru = /^margin/, be = new RegExp("^(" + ft + ")(.*)$", "i"), ot = new RegExp("^(" + ft + ")(?!px)[a-z%]+$", "i"), ke = new RegExp("^([-+])=(" + ft + ")", "i"), ti = { BODY: "block" }, de = { position: "absolute", visibility: "hidden", display: "block" }, uu = { letterSpacing: 0, fontWeight: 400 }, c = ["Top", "Right", "Bottom", "Left"], fu = ["Webkit", "O", "Moz", "ms"], ge = i.fn.toggle;
    i.fn.extend({
        css: function (n, r) {
    ...
    i.extend({
        cssHooks: {
            ...
            if (n && n.nodeType !== 3 && n.nodeType !== 8 && n.style) {
                ...
                if ((s = typeof u, s === "string" && (o = ke.exec(u)) && (u = (o[1] + 1) * o[2] + parseFloat(i.css(n, r)), s = "number"), u != null && (s !== "number" || !isNaN(u))) && (s !== "number" || i.cssNumber[h] || (u += "px"), !e || !("set" in e) || (u = e.set(n, u, f)) !== t))
                    try {
                        c[r] = u
                    } catch (l) {
                    }
    ...
    var no = /%20/g, to = /\[\]$/, eu = /\r?\n/g, io = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, ro = /^(?:select|textarea)/i;
    i.fn.extend({
        serialize: function () {
    ...
    i.fn.load = function (n, r, u) {
        ...
        return e >= 0 && (f = n.slice(e, n.length), n = n.slice(0, e)), i.isFunction(r) ? (u = r, r = t) : r && typeof r == "object" && (o = "POST"), i.ajax({
            url: n, type: o, dataType: "html", data: r, complete: function (n, t) {
    ...
    i.ajaxPrefilter("json jsonp", function (r, u, f) {
        ...
        if (r.dataTypes[0] === "jsonp" || a || v)
            return e = r.jsonpCallback = i.isFunction(r.jsonpCallback) ? r.jsonpCallback() : r.jsonpCallback, s = n[e], a ? r.url = c.replace(st, "$1" + e) : v ? r.data = h.replace(st, "$1" + e) : l && (r.url += (co.test(c) ? "&" : "?") + r.jsonp + "=" + e), r.converters["script json"] = function () {
        ...
        "*": [function (n, t) {
            ...
            if (e) {
                if (o = +e[2], s = e[3] || (i.cssNumber[n] ? "" : "px"), s !== "px" && u) {
                    ...
                    do
                        f = f || ".5", u /= f, i.style(r.elem, n, u + s);
    ...
    i.each({ slideDown: rt("show"), slideUp: rt("hide"), slideToggle: rt("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (n, t) {
    ...
    i.fn.offset = function (n) {
        ...
        if (e)
            return (o = e.body) === r ? i.offset.bodyOffset(r) : (u = e.documentElement, i.contains(u, r) ? (typeof r.getBoundingClientRect != "undefined" && (f = r.getBoundingClientRect()), s = tr(e), h = u.clientTop || o.clientTop || 0, c = u.clientLeft || o.clientLeft || 0, l = s.pageYOffset || u.scrollTop, a = s.pageXOffset || u.scrollLeft, { top: f.top + l - h, left: f.left + a - c }) : f)
    };
    i.offset = {
...
var TGDD_CDN_VERSION = "", keydtdd = "dien thoai, dien thoai di dong, dtdd, smartphone, gia dien thoai, khuyen mai dien thoai, điện thoại di động, điện thoại, giá điện thoại, dien thoai gia re, dien thoai, dien thoai di dong, dtdd, smartphone, gia dien thoai, khuyen mai dien thoai, dien thoai di dong, dien thoai, gia dien thoai, dien thoai gia re", keylaptop = "Laptop, máy tính xách tay, máy tính, Ultralbook, netbook, Notebook, giá laptop, giá máy tính xách tay, laptop cảm ứng, Laptop Touch, Laptop, may tinh xach tay, may tinh, Ultralbook, netbook, Notebook, gia laptop, gia may tinh xach tay, laptop cam ung, Laptop Touch", keymaytinhbang = "Máy tính bảng, may tinh bang, tablet, gia may tinh bang, mua ban may tinh bang, May tinh bang, may tinh bang, tablet, gia may tinh bang, mua ban may tinh bang", keymayanhso = "Camera, máy ảnh, máy ảnh số, máy chụp hình, may quay phim, giá camera, giá máy chụp ảnh, Compact, DSLR, Digital Cameras, Camera, may anh, may anh so, may chup hinh, may quay phim, gia camera, gia may chup anh, Compact, DSLR, Digital Cameras", keyphukien = "Phụ kiện, phu kien, accessories, giá cả phụ kiện, thông tin chi tiết phụ kiện, Phu kien, phu kien, accessories, gia ca phu kien, thong tin chi tiet phu kien", game = "Trò chơi trên mobile, game mobile, Tro choi tren mobile, game mobile", ungdung = "Ứng dụng, Ung dung", k_pro = "CK_CHECK_PROVINCE_OF_USER", isfancybox = !1;
var strPathCatImg = "//cdn.tgdd.vn/category/", strPathProImg = "//cdn.tgdd.vn/Products/Images/", strPathManuImg = "//cdn.tgdd.vn/brand/", searchArr = [], beginTime = 0, endTime = 0;
$(document).ready(function () {
    fancyBoxGallaryImg("a[rel^=gallerynews]");
    fancyBoxGallaryImg("a[rel^=zoom-img]");
    try {
        $("#viewdiscuss").click(function () {
            var n = $("#viewdiscuss").attr("data-surveyid"), t = $("#viewdiscuss").attr("data-newsid");
            discussshowresult(t, n)
        })
    } catch (n) {
    }
    reloadlazy();
...
flsc = !1;
/*
//# sourceMappingURL=detailNewjs.min.js.map
*/